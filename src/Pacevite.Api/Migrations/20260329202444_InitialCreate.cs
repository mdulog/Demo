        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeGroupRank = table.Column<int>(type: "integer", nullable: true),
                    FieldSize = table.Column<int>(type: "integer", nullable: true),
                    AgeGroupFieldSize = table.Column<int>(type: "integer", nullable: true),
                    Location = table.Column<Dictionary<string, object>>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SplitLabel = table.Column<string>(type: "text", nullable: false),
                    SplitSecs = table.Column<int>(type: "integer", nullable: false),
                    CumulativeSecs = table.Column<int>(type: "integer", nullable: false),
                    Metadata = table.Column<Dictionary<string, object>>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventSplits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventSplits_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_UserId_EventType",
                table: "Events",
                columns: new[] { "UserId", "EventType" });

            migrationBuilder.CreateIndex(
                name: "IX_EventSplits_EventId",
                table: "EventSplits",
                column: "EventId");
        }
